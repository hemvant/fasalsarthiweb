...
@section('title', 'Edit Irrigation Category')
@section('header', 'Edit Irrigation Category')

@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.irrigation-categories.update', $category) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
