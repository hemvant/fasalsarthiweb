...
@section('content')
    <section class="policy-hero">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">Please read these terms and conditions carefully before using our services.</p>
            <p data-aos="fade-up" data-aos-delay="200"><strong>Last Updated:</strong> {{ $page->updated_at->format('F j, Y') }}</p>
        </div>
    </section>
    <section class="policy-content terms-content">
        <div class="container">
